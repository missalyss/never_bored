    ...
    .then(function () {
      return knex('activities').insert([
        ...
        },
        {
          ...
          description: 'Thai Tom is the best Thai food in Seattle. They usually have a line that queues outside, so after you put your name in, cross the street to Good Will and look around at weird and goofy stuff. Hygine (at both locations) comes at a concern, but totally worth the trip to the emergency room. At Thai Tom, get the Poor Man Noodle or classic Chicken Phad Thai is always good.',
          cost: '💰',
          energy: '⚡️',
          time: '⏰ 0-1 hrs',
          location: '🏠 Inside',
